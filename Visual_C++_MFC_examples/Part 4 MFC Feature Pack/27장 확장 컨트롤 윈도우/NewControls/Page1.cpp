...
BOOL CPage1::OnInitDialog()
{
	...
	m_btnCheck.SetCheckedImage(afxGlobalData.bIsOSAlphaBlendingSupport ? IDB_CHECK32 : IDB_CHECK);
	...
	m_btnRadio2.SetImage(afxGlobalData.bIsOSAlphaBlendingSupport ? IDB_RADIO_OFF32 : IDB_RADIO_OFF);
	m_btnRadio3.SetImage(afxGlobalData.bIsOSAlphaBlendingSupport ? IDB_RADIO_OFF32 : IDB_RADIO_OFF);
	m_btnRadio4.SetImage(afxGlobalData.bIsOSAlphaBlendingSupport ? IDB_RADIO_OFF32 : IDB_RADIO_OFF);

	m_btnRadio1.SetCheckedImage(afxGlobalData.bIsOSAlphaBlendingSupport ? IDB_RADIO_ON32 : IDB_RADIO_ON);
	m_btnRadio2.SetCheckedImage(afxGlobalData.bIsOSAlphaBlendingSupport ? IDB_RADIO_ON32 : IDB_RADIO_ON);
	m_btnRadio3.SetCheckedImage(afxGlobalData.bIsOSAlphaBlendingSupport ? IDB_RADIO_ON32 : IDB_RADIO_ON);
	m_btnRadio4.SetCheckedImage(afxGlobalData.bIsOSAlphaBlendingSupport ? IDB_RADIO_ON32 : IDB_RADIO_ON);
