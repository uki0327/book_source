...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_wndStaticPane2.CreateEx(NULL,  _T("Test2"), this, CRect(0, 0, 100, 100),
					TRUE, 1235,
					WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS |
					WS_CLIPCHILDREN | CBRS_LEFT| CBRS_FLOAT_MULTI);

	m_wndStaticPane.EnableDocking(CBRS_ALIGN_ANY);
	m_wndStaticPane2.EnableDocking(CBRS_ALIGN_ANY);
	DockPane(&m_wndStaticPane);
	DockPane(&m_wndStaticPane2);

	pTabbedPane->AddTab(&m_wndStaticPane);
	pTabbedPane->AddTab(&m_wndStaticPane2);
