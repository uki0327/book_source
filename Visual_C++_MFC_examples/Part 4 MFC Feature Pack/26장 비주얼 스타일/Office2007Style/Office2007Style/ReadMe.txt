================================================================================
    MFC 라이브러리 : Office2007Style 프로젝트 개요
===============================================================================

응용 프로그램 마법사에서 이 Office2007Style 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 프로그램
작성을 위한 기본 구조를 제공합니다.

이 파일에는 Office2007Style 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.

Office2007Style.vcproj
...
Office2007Style.h
    ...
    헤더(Resource.h 포함)가 들어 있고 COffice2007StyleApp 응용 프로그램
    클래스를 선언합니다.

Office2007Style.cpp
    응용 프로그램 클래스 COffice2007StyleApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\Office2007Style.ico
    응용 프로그램의 아이콘으로 사용되는 아이콘 파일입니다. 이 아이콘은
    주 리소스 파일인 Office2007Style.rc에 의해 포함됩니다.

res\Office2007Style.rc2
...
Office2007StyleDoc.h, Office2007StyleDoc.cpp - 문서
    이 파일에는 COffice2007StyleDoc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 COffice2007StyleDoc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

Office2007StyleView.h, Office2007StyleView.cpp - 문서 뷰
    이 파일에는 COffice2007StyleView 클래스가 들어 있습니다.
    COffice2007StyleView 개체는 COffice2007StyleDoc 개체를 보는 데 사용됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 Office2007Style.pch와
