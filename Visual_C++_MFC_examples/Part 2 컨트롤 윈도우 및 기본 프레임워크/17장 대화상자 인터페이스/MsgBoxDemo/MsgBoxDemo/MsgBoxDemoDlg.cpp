...
BEGIN_MESSAGE_MAP(CMsgBoxDemoDlg, CDialog)
	...
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDC_Button_MessageBox, &CMsgBoxDemoDlg::OnBnClickedButtonMessagebox)
END_MESSAGE_MAP()


// CMsgBoxDemoDlg 메시지 처리기
...
void CMsgBoxDemoDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMsgBoxDemoDlg::OnBnClickedButtonMessagebox()
{
	AfxMessageBox(_T("AfxMessage() Test message!"), MB_OK | MB_ICONSTOP  );
}
