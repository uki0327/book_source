...
// CVistaButtonDemoDlg 대화 상자




CVistaButtonDemoDlg::CVistaButtonDemoDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CVistaButtonDemoDlg::IDD, pParent)
{
...
void CVistaButtonDemoDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_Command_Button, m_Command_Button);
}

BEGIN_MESSAGE_MAP(CVistaButtonDemoDlg, CDialog)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDC_Split_Button, &CVistaButtonDemoDlg::OnBnClickedSplitButton)
	ON_BN_CLICKED(IDC_Command_Button, &CVistaButtonDemoDlg::OnBnClickedCommandButton)
END_MESSAGE_MAP()


// CVistaButtonDemoDlg 메시지 처리기
...
{
	AfxMessageBox(_T("SplitButton Clicked!"));
}

void CVistaButtonDemoDlg::OnBnClickedCommandButton()
{
	AfxMessageBox(_T("CommandButton Clicked!"));
}
