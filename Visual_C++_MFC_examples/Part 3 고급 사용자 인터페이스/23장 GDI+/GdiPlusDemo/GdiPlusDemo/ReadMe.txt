================================================================================
    MFC 라이브러리 : GdiPlusDemo 프로젝트 개요
===============================================================================

응용 프로그램 마법사에서 이 GdiPlusDemo 응용 프로그램을 
만들었습니다.  이 응용 프로그램은 MFC(Microsoft Foundation Classes)의
기본적인 사용법을 보여 주며 응용 프로그램 작성을 위한 출발점을 제공합니다.

이 파일에는 GdiPlusDemo 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
GdiPlusDemo.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CGdiPlusDemoApp 응용 프로그램
    클래스를 선언합니다.

GdiPlusDemo.cpp
    응용 프로그램 클래스 CGdiPlusDemoApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\GdiPlusDemo.ico
    ...
    주 리소스 파일인 GdiPlusDemo.rc에 의해 포함됩니다.
...
GdiPlusDemoDoc.h, GdiPlusDemoDoc.cpp - 문서
    이 파일에는 CGdiPlusDemoDoc 클래스가 들어 있습니다.  이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CGdiPlusDemoDoc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

GdiPlusDemoView.h, GdiPlusDemoView.cpp - 문서 뷰
    이 파일에는 CGdiPlusDemoView 클래스가 들어 있습니다.
    CGdiPlusDemoView 개체는 CGdiPlusDemoDoc 개체를 보는 데 사용됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일인 GdiPlusDemo.pch와
